...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "không sợ bay acc à " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tớ đùa đó quay lại click đi';
document.querySelector('.Description .modal-body').innerHTML = ' <i class="fas fa-heart"></i>crush ';
